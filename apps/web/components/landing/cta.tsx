...
export function CtaSection() {
  ...
  return (
    <section ref={sectionRef} className="py-24 sm:py-32 px-4 sm:px-6 relative overflow-hidden">
      <div className="cta-glow absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(500px,80vw)] h-[min(500px,80vw)] bg-amber-700/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div ref={contentRef} className="relative mx-auto max-w-3xl text-center space-y-5 sm:space-y-6">
        <p style={{ opacity: 0 }} className="text-xs font-semibold text-amber-500 tracking-[0.2em] uppercase">
          Comece agora
        </p>
        ...
        <h2
          ...
          dangerouslySetInnerHTML={{ __html: 'Comece a&nbsp;<em class="not-italic text-gradient">melhorar</em><br/>sua loja hoje' }}
        />

        <p style={{ opacity: 0 }} className="text-stone-400 text-base sm:text-lg">
