-- Baseline schema — tenants, catalog, inventory, sales, RLS.
-- Captures what was originally applied by hand in the Supabase SQL editor.
-- Already live in production; only needed to bootstrap a fresh environment.
